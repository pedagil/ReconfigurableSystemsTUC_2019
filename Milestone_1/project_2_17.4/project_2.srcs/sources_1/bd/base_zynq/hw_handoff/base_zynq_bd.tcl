...
proc create_root_design { parentCell } {
  ...
  # Create instance: axi_bram_ctrl_port_A_ip, and set properties
  set axi_bram_ctrl_port_A_ip [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_bram_ctrl:4.0 axi_bram_ctrl_port_A_ip ]
  set_property -dict [ list \
   CONFIG.C_SELECT_XPM {0} \
   CONFIG.SINGLE_PORT_BRAM {1} \
 ] $axi_bram_ctrl_port_A_ip

  # Create instance: axi_bram_ctrl_port_B_ip, and set properties
  set axi_bram_ctrl_port_B_ip [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_bram_ctrl:4.0 axi_bram_ctrl_port_B_ip ]
  set_property -dict [ list \
   CONFIG.C_SELECT_XPM {0} \
   CONFIG.SINGLE_PORT_BRAM {1} \
 ] $axi_bram_ctrl_port_B_ip

  # Create instance: axi_dma_ip, and set properties
  set axi_dma_ip [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_dma:7.1 axi_dma_ip ]
  set_property -dict [ list \
  ...
  # Create instance: blk_mem_ip, and set properties
  set blk_mem_ip [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.4 blk_mem_ip ]
  set_property -dict [ list \
  ...
  # Create instance: dma_axi_interconnect_ic_ip, and set properties
  set dma_axi_interconnect_ic_ip [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 dma_axi_interconnect_ic_ip ]
  set_property -dict [ list \
   CONFIG.NUM_MI {1} \
   CONFIG.NUM_SI {2} \
   CONFIG.SYNCHRONIZATION_STAGES {2} \
 ] $dma_axi_interconnect_ic_ip

  # Create instance: dma_irq_concat_ip, and set properties
  ...
  set myip_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:myip:1.15 myip_0 ]
  ...
  # Create instance: ps7_0_axi_periph_ip, and set properties
  set ps7_0_axi_periph_ip [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 ps7_0_axi_periph_ip ]
  set_property -dict [ list \
   CONFIG.NUM_MI {2} \
   CONFIG.SYNCHRONIZATION_STAGES {2} \
 ] $ps7_0_axi_periph_ip
  ...
  connect_bd_intf_net -intf_net myip_0_M00_AXIS [get_bd_intf_pins axi_dma_ip/S_AXIS_S2MM] [get_bd_intf_pins myip_0/M00_AXIS]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins axi_bram_ctrl_port_A_ip/S_AXI] [get_bd_intf_pins ps7_0_axi_periph_ip/M00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_ip_M01_AXI [get_bd_intf_pins axi_dma_ip/S_AXI_LITE] [get_bd_intf_pins ps7_0_axi_periph_ip/M01_AXI]
  ...
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_bram_ctrl_port_A_ip/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_port_B_ip/s_axi_aresetn] [get_bd_pins axi_dma_ip/axi_resetn] [get_bd_pins dma_axi_interconnect_ic_ip/ARESETN] [get_bd_pins dma_axi_interconnect_ic_ip/M00_ARESETN] [get_bd_pins dma_axi_interconnect_ic_ip/S00_ARESETN] [get_bd_pins dma_axi_interconnect_ic_ip/S01_ARESETN] [get_bd_pins myip_0/m00_axis_aresetn] [get_bd_pins myip_0/s00_axis_aresetn] [get_bd_pins ps7_0_axi_periph_ip/M00_ARESETN] [get_bd_pins ps7_0_axi_periph_ip/M01_ARESETN] [get_bd_pins ps7_0_axi_periph_ip/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins dma_irq_concat_ip/dout] [get_bd_pins processing_system7_0/IRQ_F2P]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x40000000 [get_bd_addr_spaces axi_dma_ip/Data_MM2S] [get_bd_addr_segs axi_bram_ctrl_port_B_ip/S_AXI/Mem0] SEG_axi_bram_ctrl_port_B_ip_Mem0
  create_bd_addr_seg -range 0x00010000 -offset 0x40000000 [get_bd_addr_spaces axi_dma_ip/Data_S2MM] [get_bd_addr_segs axi_bram_ctrl_port_B_ip/S_AXI/Mem0] SEG_axi_bram_ctrl_port_B_ip_Mem0
  create_bd_addr_seg -range 0x00010000 -offset 0x40000000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_bram_ctrl_port_A_ip/S_AXI/Mem0] SEG_axi_bram_ctrl_0_Mem0
  create_bd_addr_seg -range 0x00010000 -offset 0x40400000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_dma_ip/S_AXI_LITE/Reg] SEG_axi_dma_ip_Reg
